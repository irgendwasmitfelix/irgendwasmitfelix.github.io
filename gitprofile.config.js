...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['irgendwasmitfelix.github.io'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1DHcOn4y6RCx03eOqG7vOEOMCtoijqdvr/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Playwright',
    'Webdriver.io',
